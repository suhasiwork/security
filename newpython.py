...
def run_bandit(clone_dir):
    ...
    st.markdown("### Security Scan Summary")
    col1, col2 = st.columns(2)
    with col1:
        st.metric(label="Total Issues", value=summary["total_issues"], delta_color="inverse")
    with col2:
        st.metric(label="Execution Time", value=summary["execution_time"], delta_color="normal")
